...
void loop()
{
    ...
    command = checkClient ();
         ...
         if (command == "forward" || command == "forward" || command == "forward")  forwardMotor();
    else if (command == "reverse" || command == "reverse"|| command == "back") reverseMotor();
    else if (command == "left"    || command == "left") leftMotor();    
    else if (command == "right"   || command == "right") rightMotor();     
    else if (command == "stop"    || command == "stop" || command == "stop" || command == "stop")     stopMotor();     
